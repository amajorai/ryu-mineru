<p align="center">
  <picture>
    ...
    <img src="./icon-light.png" alt="MinerU" width="144" />
  </picture>
</p>
...
Document parsing via MinerU (opendatalab): the heaviest and highest-fidelity `document.parse` backend, built for scientific and scanned PDFs with layout detection and OCR.
...
**App:** [Install](ryu://apps/@ryu/mineru) (opens the Ryu desktop app and asks you to confirm)

**CLI:**

```bash
ryu apps add @ryu/mineru
```
...
Reachable at `/api/ext/@ryu/mineru/*`. Every path below is declared in
...
<a href="https://github.com/amajorai/ryu-mineru/stargazers">
  <picture>
